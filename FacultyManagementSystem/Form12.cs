...
namespace FacultyManagementSystem
{
    ...
    public partial class Form12 : Form
    {
        ...
        {
            con.Open();
            string query = "SELECT COUNT(*) FROM staff WHERE staff_id = @ID";
        ...
        private void button1_Click_2(object sender, EventArgs e)
        {
            ...
            {
                con.Open();
                string query = "INSERT INTO staff(staff_id,first_name,second_name,password) VALUES (@ID,@FName,@LName,@Password)";
                SqlCommand cmd = new SqlCommand(query, con);
