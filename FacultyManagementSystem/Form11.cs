...
namespace FacultyManagementSystem
{
    public partial class Form11 : Form
    {
        ...
        string _email;
        string _password;
        public Form11(string userFname, string userLname, string userid, string useremail, string userpassword)
        {
            _id = userid;
            _Fname = userFname;
            _Lname = userLname;
        ...
        {
            con.Open();
            string query = "SELECT COUNT(*) FROM admin WHERE admin_id = @ID  AND admin_id <> @ID2";
        ...
        private void Save_Click_2(object sender, EventArgs e)
        {
            ...
            {
                con.Open();
                string qeury = "UPDATE admin SET first_name = @fname, second_name = @lname, admin_email = @email, admin_pass = @pass WHERE admin_id = @id";
